class Solution {
	...
	//initiate the boundary for possible answers, here if you let min=1 it will still work for most cases except for some corner cases. We make max=100000000 because nums[i - 1] <= 10^9. You can choose to sort the array and make the max= arr.max, at the price of time consumption.
