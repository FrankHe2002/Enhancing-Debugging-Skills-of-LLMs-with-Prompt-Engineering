The bug in the provided code is a syntax error. After the else statement in the second for loop, there is an extra closing curly brace "}". This results in a compilation error.

To fix the bug, we need to remove the extra closing curly brace "}" after the else statement in the second for loop.
