...
Reasoning: Upon reviewing the code, it seems that there is a missing semicolon (;) in the line where `putIfAbsent` method is called.

Fix: Add a semicolon (;) at the end of `graph.putIfAbsent(manager[i], new ArrayList<>())` line.
