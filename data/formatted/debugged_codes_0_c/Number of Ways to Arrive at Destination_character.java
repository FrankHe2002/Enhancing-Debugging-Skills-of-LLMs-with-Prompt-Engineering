...
1. In the line `adj.get(from).add(new Pair(to, dis);`, there is a missing closing parenthesis `)`.

To fix this bug, simply add the missing closing parenthesis `)` at the end of that line.
