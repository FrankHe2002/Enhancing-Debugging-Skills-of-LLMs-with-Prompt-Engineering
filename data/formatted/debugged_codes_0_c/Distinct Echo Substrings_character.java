...
1. Missing semicolon: There is a missing semicolon at the end of the line `Set<Integer> set = new HashSet<>()`.

Fix:

Add a semicolon at the end of the line to fix the syntax error.
