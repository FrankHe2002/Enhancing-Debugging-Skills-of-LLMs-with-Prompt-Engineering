After reviewing the code, it appears that there is a single typo/bug in the code. 
In the `Rear()` method, there is a typo where it tries to return `/ 1` instead of `- 1` when `rear == - 1`.
