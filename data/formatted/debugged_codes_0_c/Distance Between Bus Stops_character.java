In the code provided, there is a missing semicolon on line 20, which causes a compilation error.

To fix the error, we need to add a semicolon after `0` on line 20.
