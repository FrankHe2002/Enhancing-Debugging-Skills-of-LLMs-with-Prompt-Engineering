The code aims to find the nearest palindrome for a given integer `n`. 

While reviewing, I noticed that the pow function has an issue with incorrect bit manipulation, multiplies the base repeatedly, which causes the loop to run indefinitely.

To fix the issue, I will correct the `pow` function.
