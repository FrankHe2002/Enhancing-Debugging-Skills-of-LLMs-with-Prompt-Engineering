There is a bug in the code. Specifically, there is a missing semicolon in line 9, where the variable `right` is being updated inside the `for` loop.

To fix the bug, a semicolon should be added after `right += weight` in line 9 to terminate the statement correctly.
