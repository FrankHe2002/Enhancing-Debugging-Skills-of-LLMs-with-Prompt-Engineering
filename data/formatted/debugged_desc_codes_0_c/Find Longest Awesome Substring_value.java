...
Fix:
The bug in the code is in the calculation of the mask. The current calculation (2 << odd) is incorrect and should be changed to (1 << odd) in order to set the bit at the position represented by "odd".
