...
The code provided has a missing semicolon in the `getPower` method on the line `return power`.

To fix the bug, add a semicolon at the end of the line `return power;` in the `getPower` method.
