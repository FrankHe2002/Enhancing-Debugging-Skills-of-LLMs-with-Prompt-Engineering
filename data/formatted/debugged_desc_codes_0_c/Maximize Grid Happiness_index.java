Bug: The logic in the dfs function to retrieve the stored value from the dp array is incorrect which leads to incorrect retrieval of stored optimized values.

Fix:
Update the line in the dfs function from:
```java
