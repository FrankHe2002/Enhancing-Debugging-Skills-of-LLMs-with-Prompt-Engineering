The code has a bug. It seems there is a syntax error on line 14: while (! al.isEmpty)) {.

To fix this bug, we should replace al.isEmpty)) with al.isEmpty(). This will fix the syntax error.
