The code seems to have a bug in the initialization of the endingCol variable. It should be n - 1, not n * 1. Let's fix this by changing `endingCol = n * 1;` to `endingCol = n - 1;`.
