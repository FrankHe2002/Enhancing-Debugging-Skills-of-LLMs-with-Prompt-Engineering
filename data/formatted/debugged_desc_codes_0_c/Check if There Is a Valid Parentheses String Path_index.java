Bug type:
1. Typo: There is a typo in the code where "ms" is typed instead of "n" in the line `n = grid[ms].length;`, which is causing a compilation error.

Fix:
- Replace `ms` with `n` in the line `n = grid[ms].length;`
