...
Issues:
1. The comparison `dist[Arrays] >= quantity[j]` is incorrect and should be `dist[i] >= quantity[j]`
2. The `Arrays` variable is not defined and should be replaced with `i` to access the `dist` array
