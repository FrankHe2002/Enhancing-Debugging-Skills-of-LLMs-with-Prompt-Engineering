The bug is in the find() method. The formula used to append a new digit to the number `ans` is incorrect. When appending a new digit, the current `ans` value should be multiplied by 10 instead of 20.
