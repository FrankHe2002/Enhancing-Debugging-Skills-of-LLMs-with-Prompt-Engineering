The code logic seems correct at first glance. However, there seems to be an error in the second for loop condition. The loop should run until `i < nums.length`, not `i <= nums.length`, to avoid accessing an index out of bounds.
