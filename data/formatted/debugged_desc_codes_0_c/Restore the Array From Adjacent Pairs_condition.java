The code may contain a bug as the while loop condition seems incorrect. It should be while (writeIdx < n) instead of while (writeIdx > n).

I will correct the while loop condition to fix the bug.
