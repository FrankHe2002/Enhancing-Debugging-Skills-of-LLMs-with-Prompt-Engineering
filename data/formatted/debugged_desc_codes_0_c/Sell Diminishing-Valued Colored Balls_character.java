Bug:
1. The "for" loop should be "for (int j : inventory)" instead of "for (int j : inventory)" to iterate through the inventory array correctly.
2. The closing brace for the "while" loop is missing.
