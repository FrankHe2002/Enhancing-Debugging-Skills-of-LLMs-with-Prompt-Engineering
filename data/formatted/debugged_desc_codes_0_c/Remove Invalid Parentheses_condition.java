...
The removeBracket() method removeBracket String Stack<Character> might not correctly count the number of brackets to remove.

Fix: 
- I will revise the removeBracket() method to correct the logic that counts the number of brackets to remove.
