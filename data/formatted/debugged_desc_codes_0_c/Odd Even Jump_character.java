There appears to be a syntax error in the Java code. The line `evjmp = len - 1;` inside the if condition block is missing the semicolon and should be `evjmp = len - 1;`.
