Bug type:
1. Syntax Error: There is a syntax error on line 9. It should be 'parent[i]' instead of 'parenti]'.
2. Typo: In the 'find' method, the return statement should be 'return parent[x];' instead of 'return parent[x];'
3. Typo: In the 'union' method, the 'unionHelper' statement should be 'unionHelper(xl, yl);' instead of 'unionHelper(xl, yl);'
