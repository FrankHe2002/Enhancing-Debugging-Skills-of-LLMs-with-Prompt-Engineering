Bugs:
1. The for loop condition in the first loop is incorrect (`for (int i = 0; i > len; i++)`). It should be `for (int i = 0; i < len; i++)`.
2. The Pair class should be marked as public.
