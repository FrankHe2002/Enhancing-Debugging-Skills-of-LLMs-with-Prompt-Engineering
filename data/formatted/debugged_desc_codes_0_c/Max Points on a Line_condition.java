The buggy statements are in the maxPoints method. The for loop conditions are incorrect and will not execute the loop body as expected.

The correction can be done by replacing the greater than equal to ('>=') with a less than ('<').
