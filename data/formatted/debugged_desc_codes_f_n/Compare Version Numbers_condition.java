...
class Solution {
    public int compareVersion(String version1, String version2) {
        ...
        while (i < v1.length || i < v2.length) {
            // we will have initial value  0 as our array can out of index so taking that in consideration 
            Integer i1 = 0;
            Integer i2 = 0;
            // Here we are using removing Zero function which will remove all the zeros before the string
            if (i < v1.length) {
