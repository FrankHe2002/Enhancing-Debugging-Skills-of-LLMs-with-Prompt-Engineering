...
class RangeModule {
    ...
    public void addRange(int left, int right) {
        ...
        // [left, right)
        // [l1, r1) [l2, r2)
        // Note: l2 could be the same as l0, so they are either both null or both non-null
    ...
    public void removeRange(int left, int right) {
        Integer l1 = map.floorKey(left); // I used lowerKey here, since we don't care about the range starting at left, as it should be removed
        Integer l2 = map.floorKey(right); // same, we don't care about the range starting at right
