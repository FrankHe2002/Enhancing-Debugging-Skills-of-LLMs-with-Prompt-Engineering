...
# Explanation
The bug that was fixed in this code is in the `getFreqString` method. The bug was that when we append the frequency of the last character in the `freqString`, we were checking if `currFreq` is greater than 0