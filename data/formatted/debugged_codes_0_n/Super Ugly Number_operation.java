...
class Solution {
    public int nthSuperUglyNumber(int n, int[] primes) {
        ...
        for (int i = 2; i <= n; ) {
            ...
            int newval = curr.prime * dp[curr.ptr];
            if (newval > 0) {
...
```
Explanation:
In the original code, there is a bug in the compareTo() method of the Pair class. The bug is that it does not return the correct value for