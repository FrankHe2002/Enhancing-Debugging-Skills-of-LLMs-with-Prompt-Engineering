    ...
    public long maxRunTime(int n, int[] batteries) {
        ...
        while (lower <= upper) {
            ...
            if (canFit(n, mid, batteries)) {
                res = mid;
                lower = mid + 1; // Fix: used to be mid + 2
            } else {
                upper = mid - 1;
            }
        }
...
```
The bug fix is on line 47. The code was incorrectly incrementing lower by `mid + 2` instead of `mid + 1`. The correct code should increment lower by `mid + 1`.