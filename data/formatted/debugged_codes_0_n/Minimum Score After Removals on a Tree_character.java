...
class Solution {
    public int minimumScore(int[] nums, int[][] edges) {
        ...
        // Here we have to choose a SET instead of a list -> else we will run into TLS, obviously there are some duplicates.
        Map<Integer, Set<Integer>> descendants = new HashMap<>();
        computeDescendants(0, -1, descendants, adjGraph);
