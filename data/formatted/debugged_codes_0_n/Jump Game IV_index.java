...
iii> check all the indices of the list which are present in the map
once these three things have been done, we will
remove the element that is arr[until]
...
every time we check the queue we increase the answer because viewing a queue means that
we are not at the last index

I hope the idea is clear :) you'll understand better when you see the code
*/
class Solution {
