```java
// Runtime: 17 ms (Top 25.08%) | Memory: 38.7 MB (Top 25.08%)
class Solution {
    ...
    public int maxSum(int[] arr, int k, int start) {
        ...
        for (int i = 0; i < arr.length; ++i) {
            ...
            // with current element, find max if p=0...k (since subarray can be long of at most k)
            ...
            // find max between curr1 or curr2 - with current element in the subarray or outside the subarray
