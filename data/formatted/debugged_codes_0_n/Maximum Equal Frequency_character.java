...
class Solution {
    ...
    public boolean isPossibleToRemove(NavigableMap<Integer, Integer> frequenciesMap) {
        if (frequenciesMap.size() > 1) return false; //more than 1 different frequencies
    ...
    //if there's only 1 occurrence of such frequency, the frequency itself will become smaller by 1
    //if there are more than 1 occurrences of such frequency, removing 1 element will not change it
