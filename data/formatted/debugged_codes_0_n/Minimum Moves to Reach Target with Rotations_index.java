```java
// Runtime: 32 ms (Top 25.8%) | Memory: 45.52 MB (Top 12.9%)
    ...
    public int minimumMoves(int[][] grid) {
        ...
        while (! q.isEmpty()) {
            ...
            while (! q.isEmpty()) {
                ...
                if (r1 == r2 && r1 + 1 < n && r2 + 1 < n && grid[r1 + 1][c1] == 0 && grid[r2 + 1][c2] == 0 && grid[r1 + 1][c1 + 1] == 0)
                    nextq.offer(new Position(r1, c1, r1 + 1