    ...
    public int minimumMoves(int[][] grid) {
        ...
        while (!q.isEmpty()) {
            ...
            while (!q.isEmpty()) {
                ...
                if (c2 + 1 < n && grid[r2][c2 + 1] != 1)
                    nextq.offer(new Position(r1, c1 + 1, r2, c2 + 1));
                if (r2 + 1 < n && grid[r2 + 1][c2] != 1)
                    nextq.offer(new Position(r1 + 1, c1, r2 + 1, c2));

                if (r1 == r2 && r1 + 1 < n && grid[r2 + 1][c1] == 0 && grid[r2 + 1][c2] == 0 && grid[r1 + 1][c1] == 0)
                    nextq.offer(new Position(r1, c1, r1 + 1, c1));

                if (c1 == c2 && c1 + 1 < n && grid[r1][c1 + 1] == 0 && grid[r2][c1 + 1] == 0 && grid[r1][c1 + 1] == 0)
