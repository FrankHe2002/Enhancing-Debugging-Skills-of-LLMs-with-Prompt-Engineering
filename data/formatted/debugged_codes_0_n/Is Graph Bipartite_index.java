...
class Solution {
    public boolean isBipartite(int[][] graph) {
        ...
        // take two colors and color adjacent neighbours differently,
        // if any of the neighbour is already colored and is not a different color, then return false else true.
        for (int i = 0; i < n; i++) {
            if (colors[i] == 0) { // fixed bug: incorrect array index
