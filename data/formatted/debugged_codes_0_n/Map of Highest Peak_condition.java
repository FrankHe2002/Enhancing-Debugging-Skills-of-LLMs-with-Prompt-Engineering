...
class Solution {
    ...
    private void bfs(Queue<int[]> queue, int[][] heightCells) {
        while (!queue.isEmpty()) {
            ...
            // increment height of neighbor cell in all 4 directions
            // e.g, left, right, up, down
            for (int[] dir : DIRECTION) {
                int newRow = cell[0] + dir[0];
                int newCol = cell[1] + dir[1];

                // check if new coordinate of cell inside the grid or not
                ...
                // handle the neighbor of this new cell
                queue.offer(new int[] {newRow, newCol});
            }
        }
    }

    private boolean isInsideGrid(int row,