...
```
The bug is fixed by changing the condition `i % 2 != 0` to `i % 2 == 0` in the first if condition and changing the condition `i % 2 != 0` to `i % 2 == 0` in the else if condition.