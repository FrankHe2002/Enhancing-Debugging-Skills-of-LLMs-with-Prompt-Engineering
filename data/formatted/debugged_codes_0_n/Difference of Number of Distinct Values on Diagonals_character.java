...
class Solution {
    ...
    int calculate(int[][] arr, int i, int j) {
        ...
        HashSet<Integer> hs1 = new HashSet<Integer>(); // to store distinct values of upper diagonal
        HashSet<Integer> hs2 = new HashSet<Integer>(); // to store distinct values of lower diagonal
