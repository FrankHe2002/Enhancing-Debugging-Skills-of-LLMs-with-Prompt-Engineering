...
1. Missing a semicolon at the end of the statement `char[] ch = s.toCharArray()`
...
class Solution {
    public String reverseOnlyLetters(String s) {
        ...
        // using two while loops ..since the constraints are too less that's why we can prefer nested loops approach..
        while (start < end) {

            // iterating until the start pointer reaches a good character
            while (start < end && !hash.containsKey(ch[start])) {
                start++;
            }
            // iterating until the end pointer reaches the good character
        ...
        // Time Complexity: O(N) (since the loops will run only till the number of characters in the string)
