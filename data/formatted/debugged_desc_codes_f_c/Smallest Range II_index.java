The bug here is that the code does not import the Arrays class, which is needed for the sorting operation used in the sort process.
...
class Solution {
    public int smallestRangeII(int[] nums, int k) {
        ...
        // Question: Where is p?
        // Answer: We try all possible values for p and min score every time
