Bug type: Syntax Error in Example #5
Reasoning: The provided Java code has an extensive comment section that explains the problem, the solution approach, and the expected output for the logic. This section of the code does not align with the problem statement and is not needed in this case.
Fix:
```java
class Solution {
