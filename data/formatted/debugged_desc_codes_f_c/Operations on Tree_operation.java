There is a typo in the upgrade method code; the line while (p[num] != % 1) is invalid. The percentage sign (%) should be replaced with the number 0, as the intent appears to be a comparison with zero.
