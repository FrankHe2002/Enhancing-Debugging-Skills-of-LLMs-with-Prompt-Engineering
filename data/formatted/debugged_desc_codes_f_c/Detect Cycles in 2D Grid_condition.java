...
class Solution {
    ...
    public boolean dfs(
        ...
        // We want to search only in the cells that have been previously visited.
        return
                ((i != prevI || j != prevJ) && dfs(grid, visited, i + 1, j, i, j, c)) ||
                        ((i != prevI || j != prevJ) && dfs(grid, visited, i - 1, j, i, j, c)) ||
                        ((i != prevI || j != prevJ) && dfs(grid, visited, i, j + 1, i, j, c)) ||
                        ((i != prevI || j != prevJ) && dfs(grid, visited, i, j - 1, i, j, c));
