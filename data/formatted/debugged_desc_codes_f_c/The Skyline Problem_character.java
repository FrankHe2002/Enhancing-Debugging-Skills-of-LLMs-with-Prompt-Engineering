Problem:
The `getSkyline` method is erroneously creating the `height` object as `new height(b[2], b[0, true)` and `new height(b[2], b[1], false)`, respectively. Both occurrences are missing the closing square brackets in `b[0, true` and `b[1, false`.
