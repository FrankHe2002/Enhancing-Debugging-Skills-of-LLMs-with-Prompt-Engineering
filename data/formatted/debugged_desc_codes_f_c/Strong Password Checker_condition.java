...
class Solution {
    ...
    private int getNumberOfMissingComponents(String password) {
        ...
        return Math.max(digit + upper + lower, 2); // For the number of missing components, we need to add 2 after calculating the number of missing digits, upper and lower case letters
    }
}
```