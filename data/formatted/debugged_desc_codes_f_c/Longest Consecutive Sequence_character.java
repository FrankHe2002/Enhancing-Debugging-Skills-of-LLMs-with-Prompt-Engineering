...
The syntax error occurs due to a missing bracket in the line `storage.remove(inc;`. It should be fixed by adding a closing bracket outside of the `remove` method call.
