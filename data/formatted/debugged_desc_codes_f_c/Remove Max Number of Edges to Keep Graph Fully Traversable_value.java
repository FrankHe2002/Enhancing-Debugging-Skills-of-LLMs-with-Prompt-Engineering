    ...
    public int maxNumEdgesToRemove(int n, int[][] edges) {
        ...
        for (int[] edge : edges) {
            ...
            if (cat == 3) {//edge both Alice and Bob an access
                ...
                if (!tempAlice && !tempBob)//retundant or the cyclic non-dependent edge//both Alice and Bob don't rquire it connection is already there between these pair of nodes
                    removeEdge += 1;
                ...
                if (!tempBob)//no merging of set is done, that means that this edge is not required because it will form cycle or the dependency
                    removeEdge += 1;
                ...
                if (!tempAlice)//no merging of set is done, that means that this edge is not required because it will form cycle or the dependency
                    removeEdge += 1;
            }
        }
