...
Bug Explanation: There is a syntax error in the code. On line 22, there is a missing opening parenthesis after `equals`.

Fix: Add an opening parenthesis after `equals`.
