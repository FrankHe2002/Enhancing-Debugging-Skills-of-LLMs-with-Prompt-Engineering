...
The buggy code is missing a semicolon at the end of the statement `sol[0] = 1`. This causes a syntax error.

Bug Type:
Syntax Error

Fix:
Add a semicolon at the end of the statement `sol[0] = 1`.
