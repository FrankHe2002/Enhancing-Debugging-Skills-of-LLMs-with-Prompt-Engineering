...
Reasoning: The provided code has a syntax error due to missing opening and closing curly braces for the `earliestAndLatest` method.

Fix: Add the missing opening and closing curly braces for the `earliestAndLatest` method.
