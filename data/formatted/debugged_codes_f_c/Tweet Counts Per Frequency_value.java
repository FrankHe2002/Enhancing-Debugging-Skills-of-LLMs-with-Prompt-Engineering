...
Reasoning: The code is missing semicolons at the end of two lines:
1. `result += c`
2. `st = (st + 1) * - 1`

To fix the bug, add semicolons at the end of both lines.

Fixed Code:

```java
// Runtime: 351 ms (Top 16.84%) | Memory: 93.6 MB (Top 14.74%)
class TweetCounts {
