...
Reasoning: The error is a missing semicolon (`;`) at the end of the statement `dp[i] %= M` inside the second `if` block. Java requires each statement to end with a semicolon. Adding a semicolon at the end of `dp[i] %= M` corrects this syntax error.
