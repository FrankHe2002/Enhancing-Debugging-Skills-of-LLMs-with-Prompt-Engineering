Bug type: Syntax error, IndexOutOfBounds error, Logic error.

Reasoning process:
1. Look for any compiler errors or exceptions that are thrown.
2. Analyze the code and compare it to the expected behavior.
3. Identify any inconsistencies or incorrect logic.
4. Make changes to fix the identified issues.
