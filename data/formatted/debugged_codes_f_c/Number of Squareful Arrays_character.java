The bug in the provided code is a missing closing parenthesis `)` at the end of the line `set.add(nums[i);`. This causes a syntax error.

To fix this bug, we need to insert the missing closing parenthesis `)`.
