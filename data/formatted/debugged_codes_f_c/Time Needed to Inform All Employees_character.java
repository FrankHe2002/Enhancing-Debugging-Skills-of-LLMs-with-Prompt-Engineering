...
Bug Explanation: The code is missing a semicolon (`;`) after the statement `graph.putIfAbsent(manager[i], new ArrayList<>())`. This results in a syntax error.

Fix: Add a semicolon at the end of the statement `graph.putIfAbsent(manager[i], new ArrayList<>())`.
