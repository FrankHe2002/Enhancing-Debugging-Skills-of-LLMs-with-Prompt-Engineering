Bug Type: Compilation error (missing closing parentheses)

Reasoning: The buggy code has missing closing parentheses at the end of the `record Node` and `record Cell` declarations. This results in a compilation error.

Fix: Add the missing closing parentheses at the end of the `record Node` and `record Cell` declarations.
