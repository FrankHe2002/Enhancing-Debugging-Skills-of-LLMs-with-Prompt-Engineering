...
Reasoning:
The provided buggy code is missing a semicolon at the end of the statement `output[i] += i * (long) countMap.get(arr[i]) - sumMap.get(arr[i])`. This results in a syntax error. Adding a semicolon at the end of the statement will fix the bug.
