Bug Type: Syntax Error, Missing Bracket

Reasoning: The error occurs at the line `int[] indeg = new intn];`. There is a missing closing bracket after `int[] indeg = new int`. 
