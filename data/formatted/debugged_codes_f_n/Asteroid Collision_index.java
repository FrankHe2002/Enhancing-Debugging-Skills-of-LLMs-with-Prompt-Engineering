...
class Solution {
    public int[] asteroidCollision(int[] asteroids) {
        ...
        for (int a : asteroids) {
            ...
            //3. Now that we have taken care of collisions with smaller size right moving asteroids, we need to see if there's a same sized right moving asteroid. If yes, just remove that one as well. Do not