...
class Solution {
    public boolean carPooling(int[][] trips, int capacity) {
        ...
        for (int[] trip : trips) {
            ...
            destinationToPassengers.put(trip[2], currPassengersAtDrop + trip[0]); // Changed from subtraction to addition
        }
        ...
        for (int passengers : destinationToPassengers.values()) {
            ...
            if (currPassengers > capacity) { // Changed condition from '>=' to '>'
                return false;
            }
        }
        return true;
