        ...
        for (Seg curr : list) {
            ...
            if (curr.isStart) {
                ...
                if (len > 0 && res.get(len - 1).get(0) == curr.val) {
                    ...
                    temp.set(2, temp.get(2) + curr.color);
                    ...
                    temp.add(prev.get(2) + curr.color);
                    res.add(temp);
                } else {
                ...
                if (len > 0 && res.get(len - 1).get(0) == curr.val) {
                    ...
                    res.get(len - 1).set(2, prevColor - curr.color);
                } else if (len > 0 && res.get(len - 1).get(1) > curr.val) {
                    //if there is a ending in between create a new segment with different color 
                    Long prevColor = res.get(len - 1).get(2);
