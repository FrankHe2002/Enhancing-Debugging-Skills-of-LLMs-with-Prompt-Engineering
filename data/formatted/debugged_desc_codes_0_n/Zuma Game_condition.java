...
class Solution {
    static class Hand {
        ...
        Hand(String hand) {
            ...
            red = splitter.split("R", -1).length - 1;
            yellow = splitter.split("Y", -1).length - 1;
            green = splitter.split("G", -1).length - 1;
            blue = splitter.split("B", -1).length - 1;
            white = splitter.split("W", -1).length - 1;
        }
    ...
    private boolean canWin(String board, Hand hand) {
        ...
        int red = splitter.split("R", -1).length - 1;
        int yellow = splitter.split("Y", -1).length - 1;
        int green = splitter.split("G", -1).length - 1;
        int blue = splitter.split("B", -1).length - 1;
        int white = splitter.split("W", -1).length - 1;
